  ...
  return (
    <footer className="bg-white mt-20 py-10 border-t border-gray-200 ">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          <h2 className="font-bold text-2xl text-gray-900 mb-4">Shosing</h2>
          <p className="text-gray-600 mb-2 font-semibold">Address</p>
          <p className="text-gray-500 mb-4">Thủ Đức, Thành phố Hồ Chí Minh</p>
          <p className="text-gray-600 mb-2">Email</p>
          <p className="text-gray-500 mb-4">Shosing@gmail.com</p>
        ...
        {/* Section 2: Menu */}
        <div>
          <h3 className="font-semibold text-gray-600 mb-4 ml-8">Menu</h3>
          <ul className="space-y-2 ml-8">
            ...
            <li>
              <a href="/shop" className="text-gray-500 hover:text-gray-900">
                Shop
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <p className="text-gray-600 font-semibold mb-2">Follow our Social</p>
